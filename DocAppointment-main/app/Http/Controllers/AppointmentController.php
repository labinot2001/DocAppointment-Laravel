...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            'date'=>'
                    required|unique:appointments,date,NULL,id,user_id,
                    '.\Auth::id(),
            'time'=>'required'
        ...
        'Appointment created for'.$request->date);
    ...
    public function check(Request $request){
        ...
        return view('admin.appointment.index', compact('times',
        'appointmentId','date'));
    }
    public function updateTime(Request $request){
        ...
        return redirect()->route('appointment.index')->with('message'
